    ...
    public function insert_optin($content)
    {
        ...
        foreach ($optin_ids as $id) {
            ...
            if (Repository::get_customizer_value($id, 'load_optin_globally')) {
                ...
                $optin_form .= "<script type='text/javascript'>jQuery(function(){if (typeof jQuery.MailOptin !== 'undefined' && typeof jQuery.MailOptin.track_impression !== 'undefined') {jQuery.MailOptin.track_impression('$sidebar_optin_uuid');}});</script>";
