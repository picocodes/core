...
class AbstractCustomizer
{
    ...
    public function register_customizer_defaults()
    {
        ...
        $defaults['display_only_button'] = apply_filters('mo_optin_form_hide_name_field_default', false, $this->customizer_defaults, $this->optin_campaign_type, $this->optin_campaign_class);
        ...
        $defaults['cta_button_action'] = apply_filters('mo_optin_form_cta_button_action_default', 'reveal_optin_form', $this->customizer_defaults, $this->optin_campaign_type, $this->optin_campaign_class);
