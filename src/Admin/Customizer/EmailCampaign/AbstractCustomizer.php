...
class AbstractCustomizer
{
    ...
    public function register_customizer_defaults()
    {
        ...
        $defaults['email_campaign_subject'] = apply_filters('mailoptin_email_campaign_subject_default', sprintf('[New post] %s', '{{title}}'), $this->customizer_defaults, $this->email_campaign_type, $this->email_campaign_class);
        ...
        $defaults['send_immediately'] = apply_filters('mailoptin_customizer_email_campaign_send_immediately', '',$this->customizer_defaults, $this->email_campaign_type, $this->email_campaign_class);
        ...
        $defaults['content_before_main_body'] = apply_filters('mailoptin_content_before_main_body_default', '',$this->customizer_defaults, $this->email_campaign_type, $this->email_campaign_class);
