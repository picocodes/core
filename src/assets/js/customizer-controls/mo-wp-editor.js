(function ($) {
    $.fn.mo_wp_editor = function (options) {

        var default_options,
            id_regexp = new RegExp('moWPEditor', 'g');

        if (typeof tinyMCEPreInit === 'undefined' || typeof QTags === 'undefined' || typeof moWPEditor_globals === 'undefined') {
        ...
        if (tinyMCEPreInit.mceInit.moWPEditor) {
            default_options.mceInit = tinyMCEPreInit.mceInit.moWPEditor;
        }
        ...
        return this.each(function () {
            ...
            var wrap = $('<div id="wp-' + current_id + '-wrap" class="wp-core-ui wp-editor-wrap ' + options.mode + '-active" />'),
                ...
                switch_editor_html = $('<a id="' + current_id + '-html" class="wp-switch-editor switch-html" data-wp-editor-id="' + current_id + '">' + moWPEditor_globals.wpeditor_texttab_label + '</a>'),
                switch_editor_tmce = $('<a id="' + current_id + '-tmce" class="wp-switch-editor switch-tmce" data-wp-editor-id="' + current_id + '">' + moWPEditor_globals.wpeditor_visualtab_label + '</a>'),
                media_buttons = $('<div id="wp-' + current_id + '-media-buttons" class="wp-media-buttons" />'),
                insert_media_button = $('<a href="#" id="insert-media-button" class="button insert-media add_media" data-editor="' + current_id + '" title="' + moWPEditor_globals.wpeditor_addmedia_label + '"><span class="wp-media-buttons-icon"></span>' + moWPEditor_globals.wpeditor_addmedia_label + '</a>'),
            ...
            $this.before('<link rel="stylesheet" id="editor-buttons-css" href="' + moWPEditor_globals.includes_url + 'css/editor.css" type="text/css" media="all">');
