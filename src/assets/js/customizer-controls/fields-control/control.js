    ...
    wp.customize.controlConstructor["mailoptin-fields"] = wp.customize.Control.extend({
        ...
        ready: function () {
            ...
            var add_new_integration = function (e) {
                e.preventDefault();
                var index = 0;
                var preceding_index = $('.mo-fields-widget').eq(-1).data('integration-index');
                ...
                $(template_structure).insertBefore('.mo-fields__add_new').addClass('mo-fields-widget-expanded').attr('data-integration-index', index);
                contextual_display_init();

                // search and replace ID of fields
                $(this).parents('.mo-fields-block').attr('data-integration-index', index);
            };
        ...
        fetch_email_list: function () {
            ...
            $(document).on('change', "select[name='connection_service']", function () {
                ...
                $('.mo-fields-widget-title h3', parent).html(connect_service_label);
